...
def TrainML(X,y):
	...
	for model in models.keys():
		...
		print("Confusion Matrix:")
		print(conf_mat)
		print(metrics.classification_report(y_final_test,y_final_pred,digits = 4))
		print("-------------------------------------------------------------------------")
...
if __name__ == '__main__':
	...
	if(sys.argv[1]=='a' or sys.argv[1]=='A'):
		...
		X,y=DataPreprocessing(data_b)
	elif(sys.argv[1]=='c' or sys.argv[1]=='C'):
		X,y=DataPreprocessing(data_c)
	TrainML(X,y)
	#print(data_b.head())
	#print(data_c.head())
